...
PRINT = runoff.list runoff.spec README d.txt toc.hdr toc.ftr $(FILES)
...
EXTRA=\
	...
	printf.c umalloc.c\ uniq_kernel.c head_kernel.c test.c test_fcfs.c test_priority.c test_null.c ps.c uniq_user.c head_user.c\
