...
{
  char* previousline = "Teja";
  char* currline = "Venkat Teja";

  cprintf("The string length is : %d\n", strncmp(previousline, currline, 4));
  cprintf("%d", argc);
  for(int i=0; i < argc; i++){
    cprintf("Argument %d: %s\n", i, argv[i]);
  }
  return argc;
  // cprintf("It is executing in kernel mode");
  // if(argc<=1){
  //   pipeFunction();
  //   return 0;
  // }
  ...
  // }
  // if(argc > 3){
  //     cprintf("Too many arguments given");
  //     return -1;
  // }
  // return -1;
}
